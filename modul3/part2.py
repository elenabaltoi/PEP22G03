...
# for object_ in my_string:
#     print(id(my_string))
#     my_string+=object_ #string is immutuable


#modificarea listei in timp ce o literam
# x= [1,2,3,4]
# for i in x:
#     print(x.pop())
# #ca sa le scoata pe primele 2
# x= [1,2,3,4]
# for i in x:
#     print(x.pop(0))
#append este opusul lui pop
#
# list_copy=my_list.copy()
# print(("copied ID:",[id(list_copy)] ))
# for object_ in my_list:
